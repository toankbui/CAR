...
public class RiderAcceptedRides extends AppCompatActivity implements View.OnClickListener {
                    ...
                    protected void populateViewHolder(RiderActivity.PostViewHolder viewHolder, final Post model, int position) {
                        ...
                        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(RiderAcceptedRides.this, RiderPostDetails.class);
    ...
    public void onClick(View view) {
        if (view == mBack) {
            finish();
            startActivity(new Intent(RiderAcceptedRides.this, RiderActivity.class));
        }
    }
}
