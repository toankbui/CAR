...
public class RiderRequestedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        return inflater.inflate(R.layout.fragment_rider_requested, container,false);
    }
                    ...
                    protected void populateViewHolder(RiderActivity.PostViewHolder viewHolder, final Post model, int position){
                        ...
                        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                intent.putExtra("originActivity", "RiderRequestedFragment");
